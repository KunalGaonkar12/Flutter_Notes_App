  ...
  static Route onGenerateRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case '/AddNote':
        ...
        if(args.note==null){
          return _cupertinoRoute(AddNoteScreen(isUpdate: args.isUpdate as bool));
        }else{
          return _cupertinoRoute(AddNoteScreen(isUpdate: args.isUpdate as bool ,note: args.note as Note,title: args.name as String));
        }
...
class AddNoteArgument{
  ...
  final bool? isUpdate;
   ...
   AddNoteArgument({this.note, this.isUpdate, this.name,});
